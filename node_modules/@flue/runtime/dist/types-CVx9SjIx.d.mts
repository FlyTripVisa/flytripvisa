 ...
 */
interface McpUnavailableConnection {
 ...
 */
type ToolContext<S extends ToolInputSchema | undefined, H extends boolean | undefined = undefined, D extends boolean | undefined = undefined> = {
  /**
  ...
  readonly data: v.InferOutput<S>;
} : Record<never, never>) & ([H] extends [true] ? {
  readonly harness: FlueHarness;
} : Record<never, never>) & ([D] extends [true] ? {
 ...
 */
type ToolRunEnvelope<S extends ToolOutputSchema | undefined> = S extends ToolOutputSchema ? {
...
type ToolRunReturn<S extends ToolOutputSchema | undefined> = S extends ToolOutputSchema ? ToolRunEnvelope<S> | ([string] extends [v.InferInput<S>] ? string : never) : ToolRunEnvelope<S> | string;
interface ToolDefinition<TInput extends ToolInputSchema | undefined = ToolInputSchema | undefined, TOutput extends ToolOutputSchema | undefined = ToolOutputSchema | undefined, THarness extends boolean | undefined = boolean | undefined, TDurable extends boolean | undefined = boolean | undefined> {
  ...
  run(context: ToolContext<TInput, THarness, TDurable>): ToolRunReturn<TOutput> | Promise<ToolRunReturn<TOutput>> | (TOutput extends undefined ? void | Promise<void> : never);
}
type ToolInput<TTool extends ToolDefinition> = TTool extends ToolDefinition<infer TInput, any, any> ? TInput extends ToolInputSchema ? v.InferInput<TInput> : never : never;
type ToolOutput<TTool extends ToolDefinition> = TTool extends ToolDefinition<any, infer TOutput, any> ? TOutput extends ToolOutputSchema ? v.InferOutput<TOutput> : unknown : never;
//#endregion
 ...
 */
type DeliveredAttachment = PromptImage & {
  filename?: string;
};
/**
...
type RegisteredSkill = Skill | WorkspaceSkill;
/**
 ...
 * an agent.
 */
type Agent$1 = AgentFunction<AgentProps> & AgentStatics;
...
interface FlueSession {
   ...
   */
  skill<S extends v.GenericSchema>(skill: Skill | string, options: SkillOptions<S> & {
    result: S;
  }): CallHandle<PromptResultResponse<v.InferOutput<S>>>;
...
type SessionToolFactoryOptions = SandboxToolFactoryOptions;
...
type SessionToolFactory = SandboxToolFactory;
...
//#endregion
export { Sandbox as $, LlmAssistantMessage as A, ModelRequest as B, FlueEventInputCallback as C, JsonValue as Ct, FlueObservation as D, McpUnavailableConnection as Dt, FlueLogger as E, McpTransport as Et, LlmTool as F, PackagedSkillFile as G, ModelRequestInput as H, LlmToolCall as I, PromptOptions as J, PromptImage as K, LlmToolResultMessage as L, LlmMessage as M, LlmTextContent as N, FlueObservationDetail as O, LlmThinkingContent as P, RegisteredSkill as Q, LlmTurnPurpose as R, FlueEventInput as S, ToolStep as St, FlueHarness as T, McpConnectionDefinition as Tt, ModelResponse as U, ModelRequestInfo as V, PackagedSkillDirectory as W, PromptResultResponse as X, PromptResponse as Y, PromptUsage as Z, DurabilityConfig as _, ToolInput as _t, AgentProps as a, SessionToolFactoryOptions as at, FlueEventCallback as b, ToolOutputSchema as bt, AttachedAgentEvent as c, Skill as ct, CallHandle as d, SkillReference as dt, SandboxFactory as et, CompactionConfig as f, SubagentDefinition as ft, DispatchReceipt as g, ToolDefinition as gt, DeliveredMessageInput as h, ToolContext as ht, AgentFunction as i, SessionToolFactory as it, LlmImageContent as j, FlueSession as k, BashFactory as l, SkillDefinition as lt, DeliveredMessage as m, ThinkingLevel as mt, AgentConfig as n, SandboxToolFactoryOptions as nt, AgentRuntimeConfig as o, ShellOptions as ot, DeliveredAttachment as p, TaskOptions as pt, PromptModel as q, AgentDispatchRequest as r, SessionEnv as rt, AgentStatics as s, ShellResult as st, Agent$1 as t, SandboxToolFactory as tt, BashLike as u, SkillOptions as ut, FileStat as v, ToolInputSchema as vt, FlueFs as w, McpAuth as wt, FlueEventContext as x, ToolRunEnvelope as xt, FlueEvent as y, ToolOutput as yt, LlmUserMessage as z };